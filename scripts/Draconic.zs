...
recipes.addShaped(<draconicevolution:particle_generator:2>, [[<danknull:dank_null_panel_4>, <ore:blockDraconiumAwakened>, <danknull:dank_null_panel_4>],[<minecraft:diamond>, <draconicevolution:particle_generator>, <minecraft:diamond>], [<ic2:crafting:19>, <mekanism:compresseddiamond>, <ic2:crafting:19>]]);