...
recipes.addShaped(<projecte:item.pe_matter:1>, [[<projecte:item.pe_fuel:2>, <projecte:item.pe_fuel:2>, <projecte:item.pe_fuel:2>],[<projecte:item.pe_matter>, <projecte:item.pe_matter>, <projecte:item.pe_matter>], [<projecte:item.pe_fuel:2>, <projecte:item.pe_fuel:2>, <projecte:item.pe_fuel:2>]]);
recipes.addShaped(<projecte:item.pe_matter:1>, [[<projecte:item.pe_fuel:2>, <projecte:item.pe_matter>, <projecte:item.pe_fuel:2>],[<projecte:item.pe_fuel:2>, <projecte:item.pe_matter>, <projecte:item.pe_fuel:2>], [<projecte:item.pe_fuel:2>, <projecte:item.pe_matter>, <projecte:item.pe_fuel:2>]]);

#Magenta Matter
recipes.remove(<projectex:matter:0>);
recipes.addShaped(<projectex:matter>, [[<projecte:item.pe_fuel:2>, <projecte:item.pe_fuel:2>, <projecte:item.pe_fuel:2>],[<projecte:item.pe_matter:1>, <projecte:item.pe_matter:1>, <projecte:item.pe_matter:1>], [<projecte:item.pe_fuel:2>, <projecte:item.pe_fuel:2>, <projecte:item.pe_fuel:2>]]);
recipes.addShaped(<projectex:matter>, [[<projecte:item.pe_fuel:2>, <projecte:item.pe_matter:1>, <projecte:item.pe_fuel:2>],[<projecte:item.pe_fuel:2>, <projecte:item.pe_matter:1>, <projecte:item.pe_fuel:2>], [<projecte:item.pe_fuel:2>, <projecte:item.pe_matter:1>, <projecte:item.pe_fuel:2>]]);

#Pink Matter
recipes.remove(<projectex:matter:1>);
recipes.addShaped(<projectex:matter:1>, [[<projecte:item.pe_fuel:2>, <projecte:item.pe_fuel:2>, <projecte:item.pe_fuel:2>],[<projectex:matter>, <projectex:matter>, <projectex:matter>], [<projecte:item.pe_fuel:2>, <projecte:item.pe_fuel:2>, <projecte:item.pe_fuel:2>]]);
recipes.addShaped(<projectex:matter:1>, [[<projecte:item.pe_fuel:2>, <projectex:matter>, <projecte:item.pe_fuel:2>],[<projecte:item.pe_fuel:2>, <projectex:matter>, <projecte:item.pe_fuel:2>], [<projecte:item.pe_fuel:2>, <projectex:matter>, <projecte:item.pe_fuel:2>]]);

#Purple Matter
recipes.remove(<projectex:matter:2>);
recipes.addShaped(<projectex:matter:2>, [[<projecte:item.pe_fuel:2>, <projecte:item.pe_fuel:2>, <projecte:item.pe_fuel:2>],[<projectex:matter:1>, <projectex:matter:1>, <projectex:matter:1>], [<projecte:item.pe_fuel:2>, <projecte:item.pe_fuel:2>, <projecte:item.pe_fuel:2>]]);
recipes.addShaped(<projectex:matter:2>, [[<projecte:item.pe_fuel:2>, <projectex:matter:1>, <projecte:item.pe_fuel:2>],[<projecte:item.pe_fuel:2>, <projectex:matter:1>, <projecte:item.pe_fuel:2>], [<projecte:item.pe_fuel:2>, <projectex:matter:1>, <projecte:item.pe_fuel:2>]]);

#Violet Matter
recipes.remove(<projectex:matter:3>);
recipes.addShaped(<projectex:matter:3>, [[<projecte:item.pe_fuel:2>, <projecte:item.pe_fuel:2>, <projecte:item.pe_fuel:2>],[<projectex:matter:2>, <projectex:matter:2>, <projectex:matter:2>], [<projecte:item.pe_fuel:2>, <projecte:item.pe_fuel:2>, <projecte:item.pe_fuel:2>]]);
recipes.addShaped(<projectex:matter:3>, [[<projecte:item.pe_fuel:2>, <projectex:matter:2>, <projecte:item.pe_fuel:2>],[<projecte:item.pe_fuel:2>, <projectex:matter:2>, <projecte:item.pe_fuel:2>], [<projecte:item.pe_fuel:2>, <projectex:matter:2>, <projecte:item.pe_fuel:2>]]);
...
mods.extendedcrafting.TableCrafting.addShaped(4, <projectex:clay_matter>, [
	[<minecraft:clay>, <minecraft:clay>, <projectex:final_star>, <projectex:final_star>, <projectex:final_star>, <projectex:final_star>, <projectex:final_star>, <minecraft:clay>, <minecraft:clay>],
...
finalstar.addTooltip(format.red("Item duplication is disabled"));

#Philosopher Stone
recipes.remove(<projecte:item.pe_philosophers_stone>);
mods.extendedcrafting.TableCrafting.addShaped(4, <projecte:item.pe_philosophers_stone>, [
	[null, <draconicevolution:reactor_part:1>, <minecraft:end_crystal>, <minecraft:end_crystal>, <minecraft:end_crystal>, <minecraft:end_crystal>, <minecraft:end_crystal>, <draconicevolution:reactor_part:1>, null],
	[null, <minecraft:end_crystal>, <actuallyadditions:block_crystal_empowered>, <actuallyadditions:block_crystal_empowered>, <actuallyadditions:block_crystal_empowered>, <actuallyadditions:block_crystal_empowered>, <actuallyadditions:block_crystal_empowered>, <minecraft:end_crystal>, null],
	[<minecraft:end_crystal>, <actuallyadditions:block_crystal_empowered>, <actuallyadditions:block_crystal_empowered>, <ore:blockCrystalFlux>, <ore:blockCrystalFlux>, <ore:blockCrystalFlux>, <actuallyadditions:block_crystal_empowered>, <actuallyadditions:block_crystal_empowered>, <minecraft:end_crystal>],
	[<actuallyadditions:block_crystal_empowered>, <actuallyadditions:block_crystal_empowered>, <ore:blockCrystalFlux>, <ore:blockRuby>, <minecraft:tnt>, <ore:blockRuby>, <ore:blockCrystalFlux>, <actuallyadditions:block_crystal_empowered>, <actuallyadditions:block_crystal_empowered>],
	[<draconicevolution:awakened_core>, <ore:craftingSunnarium>, <xnet:netcable:1>, <ore:blockRedstone>, <ore:ingotSupremium>, <ore:blockRedstone>, <xnet:netcable:1>, <ore:craftingSunnarium>, <draconicevolution:awakened_core>],
	[<draconicevolution:draconic_energy_core>, <ore:craftingSunnarium>, <ore:slimeballBlood>, <ore:ingotSupremium>, <ore:blockUltimate>, <ore:ingotSupremium>, <ore:slimeballBlood>, <ore:craftingSunnarium>, <draconicevolution:draconic_energy_core>],
	[<ore:ingotUnstable>, <ore:blockSignalum>, <advanced_solar_panels:crafting:2>, <ore:circuitUltimate>, <ore:ingotSupremium>, <ore:circuitUltimate>, <advanced_solar_panels:crafting:2>, <ore:blockSignalum>, <ore:ingotUnstable>],
	[null, <ore:ingotUnstable>, <ore:craftingSunnarium>, <extrautils2:opinium:8>, <ore:circuitUltimate>, <extrautils2:opinium:8>, <ore:craftingSunnarium>, <ore:ingotUnstable>, null],
	[null, null, <ore:ingotUnstable>, <ic2:nuclear:10>, <advanced_solar_panels:crafting:5>, <ic2:nuclear:10>, <ore:ingotUnstable>, null, null]
]);

#Transmutation Table
recipes.remove(<projecte:transmutation_table>);
mods.extendedcrafting.TableCrafting.addShaped(4, <projecte:transmutation_table>, [
	[<projecte:matter_block>, <projecte:matter_block>, <tconstruct:large_plate>.withTag({Material:"blackquartz_plustic"}), <tconstruct:large_plate>.withTag({Material:"refinediron"}), <tconstruct:large_plate>.withTag({Material:"chaoticdraconium"}), <tconstruct:large_plate>.withTag({Material:"refinediron"}), <tconstruct:large_plate>.withTag({Material:"blackquartz_plustic"}), <projecte:matter_block>, <projecte:matter_block>],
	[<projecte:matter_block>, <projecte:matter_block>, <draconicevolution:wyvern_core>, <ore:blockLudicrite>, <ore:blockLudicrite>, <ore:blockLudicrite>, <draconicevolution:wyvern_core>, <projecte:matter_block>, <projecte:matter_block>],
	[<tconstruct:large_plate>.withTag({Material:"blackquartz_plustic"}), <draconicevolution:wyvern_core>, <mysticalagriculture:crafting:9>, <draconicevolution:wyvern_energy_core>, <ore:blockLudicrite>, <draconicevolution:wyvern_energy_core>, <mysticalagriculture:crafting:9>, <draconicevolution:wyvern_core>, <tconstruct:large_plate>.withTag({Material:"blackquartz_plustic"})],
	[<tconstruct:large_plate>.withTag({Material:"refinediron"}), <ore:blockLudicrite>, <draconicevolution:wyvern_energy_core>, <quark:quilted_wool:6>, <projecte:item.pe_klein_star:2>.withTag({}), <quark:quilted_wool:6>, <draconicevolution:wyvern_energy_core>, <ore:blockLudicrite>, <tconstruct:large_plate>.withTag({Material:"refinediron"})],
	[<tconstruct:large_plate>.withTag({Material:"chaoticdraconium"}), <ore:blockLudicrite>, <ore:blockLudicrite>, <projecte:item.pe_klein_star:2>.withTag({}), <projecte:item.pe_philosophers_stone>.withTag({}), <projecte:item.pe_klein_star:2>.withTag({}), <ore:blockLudicrite>, <ore:blockLudicrite>, <tconstruct:large_plate>.withTag({Material:"chaoticdraconium"})],
	[<tconstruct:large_plate>.withTag({Material:"refinediron"}), <ore:blockLudicrite>, <draconicevolution:wyvern_energy_core>, <quark:quilted_wool:6>, <projecte:item.pe_klein_star:2>.withTag({}), <quark:quilted_wool:6>, <draconicevolution:wyvern_energy_core>, <ore:blockLudicrite>, <tconstruct:large_plate>.withTag({Material:"refinediron"})],
	[<tconstruct:large_plate>.withTag({Material:"blackquartz_plustic"}), <draconicevolution:wyvern_core>, <mysticalagriculture:crafting:9>, <draconicevolution:wyvern_energy_core>, <ore:blockLudicrite>, <draconicevolution:wyvern_energy_core>, <mysticalagriculture:crafting:9>, <draconicevolution:wyvern_core>, <tconstruct:large_plate>.withTag({Material:"blackquartz_plustic"})],
	[<projecte:matter_block>, <projecte:matter_block>, <draconicevolution:wyvern_core>, <ore:blockLudicrite>, <ore:blockLudicrite>, <ore:blockLudicrite>, <draconicevolution:wyvern_core>, <projecte:matter_block>, <projecte:matter_block>],
	[<projecte:matter_block>, <projecte:matter_block>, <tconstruct:large_plate>.withTag({Material:"blackquartz_plustic"}), <tconstruct:large_plate>.withTag({Material:"refinediron"}), <projectex:stone_table>, <tconstruct:large_plate>.withTag({Material:"refinediron"}), <tconstruct:large_plate>.withTag({Material:"blackquartz_plustic"}), <projecte:matter_block>, <projecte:matter_block>]
]);
...
mods.extendedcrafting.TableCrafting.addShaped(4, <projecte:item.pe_transmutation_tablet>, [
	...
	[<minecraft:enchanted_book>.withTag({StoredEnchantments:[{lvl:1 as short,id:33 as short}]}), <minecraft:enchanted_book>.withTag({StoredEnchantments:[{lvl:3 as short,id:35 as short}]}), <tconstruct:large_plate>.withTag({Material:"ludicrite"}), <tconstruct:large_plate>.withTag({Material:"awakened_plustic"}), <projecte:transmutation_table>, <tconstruct:large_plate>.withTag({Material:"awakened_plustic"}), <tconstruct:large_plate>.withTag({Material:"ludicrite"}), <minecraft:enchanted_book>.withTag({StoredEnchantments:[{lvl:1 as short,id:50 as short}]}), <minecraft:enchanted_book>.withTag({StoredEnchantments:[{lvl:1 as short,id:6 as short}]})],
...
#Red Mob
mods.extendedcrafting.CombinationCrafting.addRecipe(<projecte:item.pe_fuel:1> *1, 16, 16, <projecte:item.pe_covalence_dust>, [<projecte:item.pe_fuel:0>, <projecte:item.pe_fuel:0>, <projecte:item.pe_fuel:0>, <projecte:item.pe_fuel:0>]);
...
#Red Aeter
mods.extendedcrafting.CombinationCrafting.addRecipe(<projecte:item.pe_fuel:2> *1, 32, 32, <projecte:item.pe_covalence_dust>, [<projecte:item.pe_fuel:1>, <projecte:item.pe_fuel:1>, <projecte:item.pe_fuel:1>, <projecte:item.pe_fuel:1>]);
...
mods.extendedcrafting.TableCrafting.addShaped(4, <projecte:item.pe_tome>, [
	[<minecraft:bookshelf>, <minecraft:bookshelf>, <projectex:knowledge_sharing_book>, <projectex:clay_matter>, <projectex:clay_matter>, <projectex:clay_matter>, <projectex:knowledge_sharing_book>, <minecraft:bookshelf>, <minecraft:bookshelf>],
	[<minecraft:bookshelf>, <projectex:clay_matter>, <projectex:clay_matter>, <projectex:clay_matter>, <projectex:clay_matter>, <projectex:clay_matter>, <projectex:clay_matter>, <projectex:clay_matter>, <minecraft:bookshelf>],
	[<projectex:knowledge_sharing_book>, <projectex:clay_matter>, <minecraft:writable_book>, <solcarrot:food_book>, <projectex:clay_matter>, <cyclicmagic:book_ender>.withTag({location_back:""}), <hammercore:manual>, <projectex:clay_matter>, <projectex:knowledge_sharing_book>],
	[<projectex:clay_matter>, <projectex:clay_matter>, <minecraft:enchanted_book>, <agricraft:journal>, <actuallyadditions:item_booklet>, <cookingforblockheads:recipe_book:2>, <xnet:xnet_manual>, <projectex:clay_matter>, <projectex:clay_matter>],
	[<projectex:clay_matter>, <projectex:clay_matter>, <projectex:clay_matter>, <industrialforegoing:book_manual>, <projecte:item.pe_manual>, <extrautils2:book>, <projectex:clay_matter>, <projectex:clay_matter>, <projectex:clay_matter>],
	[<projectex:clay_matter>, <projectex:clay_matter>, <tconstruct:book>, <draconicevolution:info_tablet>, <minecraft:book>, <extendedcrafting:guide>, <rftools:rftools_manual>, <projectex:clay_matter>, <projectex:clay_matter>],
	[<projectex:knowledge_sharing_book>, <projectex:clay_matter>, <rftoolscontrol:rftoolscontrol_manual>, <rftools:rftools_shape_manual>, <projectex:clay_matter>, <rftoolsdim:rftoolsdim_manual>, <openblocks:info_book>, <projectex:clay_matter>, <projectex:knowledge_sharing_book>],
	[<minecraft:bookshelf>, <projectex:clay_matter>, <projectex:clay_matter>, <projectex:clay_matter>, <projectex:clay_matter>, <projectex:clay_matter>, <projectex:clay_matter>, <projectex:clay_matter>, <minecraft:bookshelf>],
	[<minecraft:bookshelf>, <minecraft:bookshelf>, <projectex:knowledge_sharing_book>, <projectex:clay_matter>, <projectex:clay_matter>, <projectex:clay_matter>, <projectex:knowledge_sharing_book>, <minecraft:bookshelf>, <minecraft:bookshelf>]
]);
...
recipes.addShaped(<projectex:arcane_tablet>, [[<projectex:stone_table>, <avaritia:double_compressed_crafting_table>, <projectex:stone_table>],[<projectex:magnum_star_omega>, <projecte:item.pe_transmutation_tablet>, <projectex:magnum_star_omega>], [<projectex:stone_table>, <draconicevolution:draconium_chest>, <projectex:stone_table>]]);

#Compressed Refined EMC Link
recipes.remove(<projectex:compressed_refined_link>);
recipes.addShaped(<projectex:compressed_refined_link>, [[<projectex:refined_link>, <projectex:refined_link>, <projectex:refined_link>],[<projectex:refined_link>, <projectex:refined_link>, <projectex:refined_link>], [<projectex:refined_link>, <projectex:refined_link>, <projectex:refined_link>]]);
