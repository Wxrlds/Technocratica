...
recipes.addShaped("Crude_Energy_Conduit", <enderio:item_endergy_conduit> * 8, [
    [<enderio:item_material:4>, <enderio:item_material:4>, <enderio:item_material:4>],
    [<enderio:item_alloy_endergy_ingot>, <xnet:netcable>, <enderio:item_alloy_endergy_ingot>],
    [<enderio:item_material:4>, <enderio:item_material:4>, <enderio:item_material:4>]
]);
...
recipes.addShaped("Iron_Energy_Conduit", <enderio:item_endergy_conduit:1> * 3, [
    [<enderio:item_alloy_ingot:9>, <enderio:item_material:4>, <enderio:item_material:4>],
    [<enderio:item_endergy_conduit>, <enderio:item_material:75>, <enderio:item_material:4>],
    [<enderio:item_alloy_ingot:9>, <enderio:item_material:4>, <enderio:item_material:4>]
]);
...
recipes.addShaped("XNet_Cable", <xnet:netcable> * 32, [
    [<minecraft:string>, <tesslocator:basic_item_tesslocator>, <minecraft:string>],
    [<ore:nuggetGold>, <minecraft:redstone>, <ore:nuggetGold>],
    [<minecraft:string>, <tesslocator:basic_fluid_tesslocator>, <minecraft:string>]
]);

#Item Conduit
recipes.remove(<enderio:item_item_conduit>);

recipes.addShaped("Item_Condiut", <enderio:item_item_conduit> * 8, [
    [<ore:itemConduitBinder>, <ore:itemConduitBinder>, <ore:itemConduitBinder>],
    [<ore:nuggetPulsatingIron>, <xnet:netcable>, <ore:nuggetPulsatingIron>],
    [<ore:itemConduitBinder>, <ore:itemConduitBinder>, <ore:itemConduitBinder>]
]);
...
recipes.addShaped("Fluid_Conduit", <enderio:item_liquid_conduit> * 8, [
    [<ore:itemConduitBinder>, <ore:itemConduitBinder>, <ore:itemConduitBinder>],
    [<ore:fusedGlass>, <xnet:netcable>, <ore:fusedGlass>],
    [<ore:itemConduitBinder>, <ore:itemConduitBinder>, <ore:itemConduitBinder>]
]);
...
recipes.addShaped("Fluid_Laser", <actuallyadditions:block_laser_relay_fluids> * 2, [
    [<actuallyadditions:block_crystal_empowered:2>, <ore:oreRedstone>, <actuallyadditions:block_crystal_empowered:4>],
    [<ore:ingotStellarAlloy>, <actuallyadditions:block_crystal_empowered:3>, <ore:ingotStellarAlloy>],
    [<actuallyadditions:block_crystal_empowered:5>, <actuallyadditions:block_crystal_empowered>, <actuallyadditions:block_crystal_empowered:1>]
]);
