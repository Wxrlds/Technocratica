...
recipes.addShaped(<tconstruct:slime_boots>, [
    ...
    [<tconstruct:slime_congealed>, <minecraft:iron_boots>, <tconstruct:slime_congealed>]
]);
...
recipes.addShaped(<tconstruct:slime_boots:1>, [
    ...
    [<tconstruct:slime_congealed:1>, <minecraft:iron_boots>, <tconstruct:slime_congealed:1>]
]);
...
recipes.addShaped(<tconstruct:slime_boots:2>, [
    ...
    [<tconstruct:slime_congealed:2>, <minecraft:iron_boots>, <tconstruct:slime_congealed:2>]
]);
...
recipes.addShaped(<tconstruct:slime_boots:3>, [
    ...
    [<tconstruct:slime_congealed:3>, <minecraft:iron_boots>, <tconstruct:slime_congealed:3>]
]);
...
recipes.addShaped(<tconstruct:slime_boots:4>, [
    ...
    [<tconstruct:slime_congealed:4>, <minecraft:iron_boots>, <tconstruct:slime_congealed:4>]
]);

#Longfall Boots
recipes.remove(<longfallboots:longfallboots>);

recipes.addShaped(<longfallboots:longfallboots>, [
    [<ore:ingotIron>, <rftools:featherfallingplus_module>, <ore:ingotIron>],
    [<ore:obsidian>, <tconstruct:slime_boots:*>, <ore:obsidian>],
